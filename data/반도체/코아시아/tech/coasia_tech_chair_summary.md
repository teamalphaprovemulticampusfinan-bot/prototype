...
- Source: `C:/Agent_6.9/data/반도체/코아시아/tech/tech_ip_evidence_composite.json`
...
### 2) 핵심 해석
- 코아시아의 개인투자자용 Tech 최종 점수는 54.95/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다.
- 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(39.0)와 IP Evidence(53.99) 및 Excel 기반 정량 근거(90.0)를 함께 반영했습니다.
...
| tech.inv.ev.007 | tech_summary | **Tech Agent 핵심 해석**: 코아시아의 개인투자자용 Tech 최종 점수는 53.55/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다. | - | 중 |
| tech.inv.ev.008 | tech_summary | **Tech Agent 핵심 해석**: 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(39.0)와 IP Evidence(53.99) 및 Excel 기반 정량 근거(90.0)를 함께 반영했습니다. | - | 중 |
