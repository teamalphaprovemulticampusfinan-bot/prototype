...
## 1. Chair 반영용 핵심 판단
- **의견:** 보유
- **Tech-to-Value:** base 21.50/100 / 기술-재무 괴리형(TECH_FINANCE_GAP)
- **Peer-adjusted:** 21.50/100 / 기술-재무 괴리형(TECH_FINANCE_GAP)
...
|---|---:|---:|---:|---|
| Tech-to-Value Bridge | 61.43 | 0.40 | 24.57 | 기술이 고객 채택·양산·매출 전환으로 이어질 가능성 |
...
### 2) 핵심 해석
- SFA반도체의 개인투자자용 Tech 최종 점수는 64.90/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다.
- 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(61.43)와 IP Evidence(57.14) 및 Excel 기반 정량 근거(90.0)를 함께 반영했습니다.
- 투자자가 확인할 핵심 근거는 14개로 정리했으며, 중복 뉴스·중복 항목은 제외했습니다.

### 3) 개인투자자가 확인할 근거
| ID | 출처 | 근거 | 값 | 강도 |
|---|---|---|---:|---|
| tech.inv.ev.001 | tech_to_value | **최종 Tech-to-Value Bridge**: SFA반도체의 최종 기술-사업화 연결 점수는 21.5이며, Chair에는 기술성보다 고객 채택·양산·매출 전환 가능성을 우선 반영합니다. | 21.5점 | 상 |
...
| tech.inv.ev.004 | excel_frame | **peer_group 기반 기술 후보 수**: 원천 확인 후 수치 보강 | 16개 | 상 |
| tech.inv.ev.005 | excel_frame | **반도체 value-chain 분류**: 원천 확인 후 수치 보강 | 1개 | 상 |
| tech.inv.ev.006 | excel_frame | **제품 후보 축**: 원천 확인 후 수치 보강 | 9개 | 상 |
...
| tech.inv.ev.012 | tech_summary | **Tech Agent 핵심 해석**: SFA반도체의 개인투자자용 Tech 최종 점수는 64.90/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다. | - | 중 |
| tech.inv.ev.013 | tech_summary | **Tech Agent 핵심 해석**: 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(61.43)와 IP Evidence(57.14) 및 Excel 기반 정량 근거(90.0)를 함께 반영했습니다. | - | 중 |
