# 두산테스나 Tech Local Proxy Evidence

- company_name: 두산테스나
- company_slug: doosan_tesna
- stock_code: 131970
- market: KOSDAQ
- peer_group: 테스트
...
두산테스나은 Universe CSV에서 '테스트' peer_group으로 분류되어 있습니다.
이 분류에 따라 Tech Agent는 다음 기술 후보 키워드를 우선 탐색합니다: 반도체, 공정, 양산, 고객, R&D, 특허, 기술경쟁력, 테스트, 검사, 소켓, 신뢰성, 수율.

## 대표 기술 후보

- 반도체 value chain 내 위치: 테스트
- 탐색해야 할 기술 축: 반도체, 공정, 양산, 고객, R&D, 특허, 기술경쟁력, 테스트, 검사, 소켓
- 핵심 확인 필요 항목: 제품/공정 직접성, 고객 적용 여부, 양산/수율/신뢰성 지표, R&D 및 특허 근거, 전방산업 확장성

## 핵심 제품/서비스 후보

- peer_group 기준 후보: 테스트
