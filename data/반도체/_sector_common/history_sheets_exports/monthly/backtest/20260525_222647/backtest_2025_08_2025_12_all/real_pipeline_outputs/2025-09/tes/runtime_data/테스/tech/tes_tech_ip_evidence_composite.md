# 테스 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 52.69
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 57.32 | 14.33 | OK | IP_LEGAL_STABILITY_NEUTRAL |
| claim_defense | 청구항 방어 범위 | 0.3 | 57.71 | 17.31 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 30.55 | 7.64 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 67.07 | 13.41 | OK | IP_GLOBAL_EXTENSION_POSITIVE |
