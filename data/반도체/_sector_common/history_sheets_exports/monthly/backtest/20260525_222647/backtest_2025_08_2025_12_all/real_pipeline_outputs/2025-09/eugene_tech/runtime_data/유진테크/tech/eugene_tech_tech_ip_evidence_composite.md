# 유진테크 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 55.01
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 78.02 | 19.5 | OK | IP_LEGAL_STABILITY_NEUTRAL_POSITIVE |
| claim_defense | 청구항 방어 범위 | 0.3 | 58.31 | 17.49 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 45.0 | 11.25 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 33.81 | 6.76 | OK | IP_GLOBAL_EXTENSION_WEAK |
