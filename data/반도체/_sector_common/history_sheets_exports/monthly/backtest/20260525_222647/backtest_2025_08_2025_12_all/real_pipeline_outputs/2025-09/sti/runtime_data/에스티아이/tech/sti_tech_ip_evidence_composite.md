# 에스티아이 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 39.18
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 47.84 | 11.96 | OK | IP_LEGAL_STABILITY_NEUTRAL |
| claim_defense | 청구항 방어 범위 | 0.3 | 49.64 | 14.89 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 42.93 | 10.73 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 7.97 | 1.59 | OK | IP_GLOBAL_EXTENSION_WEAK |
