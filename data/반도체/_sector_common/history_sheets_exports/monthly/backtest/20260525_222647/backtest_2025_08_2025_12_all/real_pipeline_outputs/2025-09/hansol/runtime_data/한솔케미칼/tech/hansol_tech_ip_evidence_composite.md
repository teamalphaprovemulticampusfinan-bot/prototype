# 한솔케미칼 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 52.94
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 71.75 | 17.94 | OK | IP_LEGAL_STABILITY_NEUTRAL_POSITIVE |
| claim_defense | 청구항 방어 범위 | 0.3 | 52.98 | 15.89 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 45.0 | 11.25 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 39.3 | 7.86 | OK | IP_GLOBAL_EXTENSION_NEUTRAL |
