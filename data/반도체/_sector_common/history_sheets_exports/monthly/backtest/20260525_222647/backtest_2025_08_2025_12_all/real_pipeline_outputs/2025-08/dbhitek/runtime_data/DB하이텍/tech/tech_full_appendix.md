...
|---|---|---:|---|---|---|
| 대표 기술 | 핵심 기술 키워드 | 4 / 5 (기술성) | DB하이텍은 Universe CSV에서 '파운드리/제조' peer_group으로 분류되어 있습니다.; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화... | 강 | data\반도체\DB하이텍\tech\source\dbhitek_tech_local_proxy_evidence... |
| 핵심 제품/서비스 | 제품명/서비스명 | 3 / 5 (수익성 기여) | DB하이텍은 Universe CSV에서 '파운드리/제조' peer_group으로 분류되어 있습니다.; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화... | 중 | data\반도체\DB하이텍\tech\source\dbhitek_tech_local_proxy_evidence... |
| 고객 구매 이유 | 고객 효익 | 3 / 5 (고객 채택도) | DB하이텍은 Universe CSV에서 '파운드리/제조' peer_group으로 분류되어 있습니다.; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화... | 중 | data\반도체\DB하이텍\tech\source\dbhitek_tech_local_proxy_evidence... |
| 경쟁 우위/대체가능성 | 등록 특허 | 3 / 5 (진입장벽) | DB하이텍은 Universe CSV에서 '파운드리/제조' peer_group으로 분류되어 있습니다.; 직접근거 4건, 공식/DART/IR/특허 근거 0건, 정량화... | 중 | data\반도체\DB하이텍\tech\source\dbhitek_tech_local_proxy_evidence... |
...
| 진입 부담/장벽 | 인증/승인 | 3 / 5 (양산성) | DB하이텍은 Universe CSV에서 '파운드리/제조' peer_group으로 분류되어 있습니다.; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화... | 중 | data\반도체\DB하이텍\tech\source\dbhitek_tech_local_proxy_evidence... |
| R&D 강도 | 연구개발비 | 3 / 5 (투자 지속성) | DB하이텍은 Universe CSV에서 '파운드리/제조' peer_group으로 분류되어 있습니다.; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화... | 중 | data\반도체\DB하이텍\tech\source\dbhitek_tech_local_proxy_evidence... |
...
### 9-4. 해석
- dbhitek의 Tech/IP Strength Index는 0.0/100, percentile 50.0로 산출되어 근거 보강 필요 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
