# 텔레칩스 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 52.32
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 85.0 | 21.25 | OK | IP_LEGAL_STABILITY_STRONG_POSITIVE |
| claim_defense | 청구항 방어 범위 | 0.3 | 56.06 | 16.82 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 42.33 | 10.58 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 18.33 | 3.67 | OK | IP_GLOBAL_EXTENSION_WEAK |
