# 원익머트리얼즈 Tech Local Proxy Evidence

- company_name: 원익머트리얼즈
- company_slug: wonik_materials
- stock_code: 104830
- market: KOSDAQ
- peer_group: 소재
...
원익머트리얼즈은 Universe CSV에서 '소재' peer_group으로 분류되어 있습니다.
이 분류에 따라 Tech Agent는 다음 기술 후보 키워드를 우선 탐색합니다: 반도체, 공정, 양산, 고객, R&D, 특허, 기술경쟁력, 반도체 소재, 전구체, 고순도, 식각, 세정, 증착.

## 대표 기술 후보

- 반도체 value chain 내 위치: 소재
- 탐색해야 할 기술 축: 반도체, 공정, 양산, 고객, R&D, 특허, 기술경쟁력, 반도체 소재, 전구체, 고순도
