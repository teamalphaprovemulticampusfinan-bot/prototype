# 솔브레인 Tech Agent Full Appendix

- **생성 시각:** 2026-05-26T01:25:28
...
- **산출물 상태:** 확인됨: `data/반도체/솔브레인/tech/soulbrain_tech_high_quality_report.md`
- **의미:** 기존 Excel 틀(high_quality_report.py)의 대분류를 Tech Agent 소유 풀버전 부록으로 옮긴 영역입니다.

| 대분류 | 항목 | 정량화 | 핵심 근거 | 등급 | 비고 |
|---|---|---:|---|---|---|
| 대표 기술 | 핵심 기술 키워드 | 4 / 5 (기술성) | 솔브레인은 Universe CSV에서 '소재' peer_group으로 분류되어 있습니다.; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 4건 | 강 | data\반도체\솔브레인\tech\source\soulbrain_tech_local_proxy_evidenc... |
| 핵심 제품/서비스 | 제품명/서비스명 | 3 / 5 (수익성 기여) | 핵심 원천 근거 추가 필요; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 4건 | 중 | - |
...
| 활용 및 확장 산업 | 활용 산업 | 3 / 5 (확장성) | # 솔브레인 Tech Local Proxy Evidence; 직접근거 6건, 공식/DART/IR/특허 근거 0건, 정량화 지표 3건 | 중 | data\반도체\솔브레인\tech\source\soulbrain_tech_local_proxy_evidenc... |
...
- **산출물 상태:** 확인됨: `data/반도체/솔브레인/tech/soulbrain_tech_to_value_inputs.json`
| 항목 | 값 | 해석 |
|---|---:|---|
...
- **산출물 상태:** 확인됨: `data/반도체/솔브레인/tech/soulbrain_tech_patent_evidence.json`
| 원천 신호 | 값 |
|---|---:|
| 정규화 특허 텍스트 레코드 | 3,800건 |
| 회사 출원인/권리자 매칭 | 2,840건 |
| 등록 특허 | 233건 |
| 존속 가능 특허 | 2,344건 |
| 최근 5년 특허 | 1,560건 |
| IPC/CPC 다양성 | 5개 |
...
| 대표 특허 예시 | 상태/연도 |
|---|---|
| 원자층 식각 물질, 원자층 식각 방법, 이로부터 제조된 반도체 기판 및 반도체 소자 | 등록 |
| 계단율 개선제, 이를 이용한 박막 형성 방법, 이로부터 제조된 반도체 기판 및 반도체 소자 | 등록 |
| 식각용 조성물 및 이를 이용한 반도체 소자의 제조방법 | 등록 |
| 화학적 기계적 연마 조성물 및 이를 이용한 반도체 소자의 제조 방법 | 등록 |
| 진공 기반 박막 개질제, 이를 포함한 박막 개질 조성물, 이를 이용한 박막 형성 방법, 이로부터 제조된 반도체 기판 및 반도체 소자 | 공개 |
## Step 4. Patent KMeans clustering
- **산출물 상태:** 확인됨: `data/반도체/솔브레인/tech/tech_ml_signal.json`
| 항목 | 값 |
|---|---:|
| 모델 | tfidf_kmeans |
| 정규화 특허 텍스트 레코드 | 90건 |
...
|---:|---:|---|---|
| 2 | 39건 | 반도체, 식각, 박막, 기판 | 기술 텍스트 유사도 기반 클러스터 |
| 3 | 19건 | 전해액, 리튬, 이차, 리튬 이차 | 기술 텍스트 유사도 기반 클러스터 |
| 1 | 18건 | 슬러리, 연마, 화학적 기계적, 기계적, 화학적, 세륨, 산화 세륨, 산화 | 기술 텍스트 유사도 기반 클러스터 |
| 0 | 14건 | 자외선, 자외선 차단제, 차단제, 세륨옥사이드, 포함하는 자외선, 도전성, 이방 | 기술 텍스트 유사도 기반 클러스터 |
...
- **산출물 상태:** 확인됨: `data/반도체/솔브레인/tech/tech_ip_ml.json`
### 9-1. Tech/IP Strength Index
| 항목 | 값 | 해석 |
|---|---:|---|
| Tech/IP Strength Index | 67.14/100 | 특허 등록률·존속성·최근성·IPC/CPC 다양성·핵심기술 키워드 밀도 점수를 통합한 IP 강도 지표입니다. |
| Reference Universe Percentile | 50.00% | reference universe 안에서의 상대적 기술/IP 위치입니다. |
| Patent Momentum Score | 66.20/100 | 최근 특허 활동과 기술 포트폴리오 지속성을 반영합니다. |
...
### 9-4. 해석
- soulbrain의 Tech/IP Strength Index는 67.14/100, percentile 50.0로 산출되어 평균 이상 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
...
### 10-5. 해석
- 솔브레인의 Technology Differentiation Score는 peer 대비 기술/IP 포트폴리오 차별성 신호입니다.
...
| 구분 | 경로 | 상태 |
|---|---|---|
| chair_summary | `data/반도체/솔브레인/tech/tech_chair_summary.json` | 확인됨 |
| tech_packet | `data/반도체/솔브레인/tech/tech.json` | 확인됨 |
| high_quality_md | `data/반도체/솔브레인/tech/soulbrain_tech_high_quality_report.md` | 확인됨 |
| tech_to_value | `data/반도체/솔브레인/tech/soulbrain_tech_to_value_inputs.json` | 확인됨 |
| patent_json | `data/반도체/솔브레인/tech/soulbrain_tech_patent_evidence.json` | 확인됨 |
| ml_signal | `data/반도체/솔브레인/tech/tech_ml_signal.json` | 확인됨 |
...
| tech_ip_ml | `data/반도체/솔브레인/tech/tech_ip_ml.json` | 확인됨 |
