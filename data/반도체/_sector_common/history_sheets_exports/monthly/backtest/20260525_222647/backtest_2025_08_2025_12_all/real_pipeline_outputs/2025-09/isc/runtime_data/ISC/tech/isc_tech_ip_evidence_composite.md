# ISC IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 62.36
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 92.0 | 23.0 | OK | IP_LEGAL_STABILITY_STRONG_POSITIVE |
| claim_defense | 청구항 방어 범위 | 0.3 | 71.91 | 21.57 | OK | IP_CLAIM_SCOPE_POSITIVE |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 29.0 | 7.25 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 52.67 | 10.53 | OK | IP_GLOBAL_EXTENSION_NEUTRAL |
