# 두산테스나 Tech Agent Full Appendix
...
- **산출물 상태:** 확인됨: `data/반도체/두산테스나/tech/doosan_tesna_tech_high_quality_report.md`
...
| 핵심 제품/서비스 | 제품명/서비스명 | 3 / 5 (수익성 기여) | 두산테스나은 Universe CSV에서 '테스트' peer_group으로 분류되어 있습니다.; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 ... | 중 | data\반도체\두산테스나\tech\source\doosan_tesna_tech_local_proxy_evi... |
...
| 활용 및 확장 산업 | 활용 산업 | 3 / 5 (확장성) | # 두산테스나 Tech Local Proxy Evidence; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 3건 | 중 | data\반도체\두산테스나\tech\source\doosan_tesna_tech_local_proxy_evi... |
...
- **산출물 상태:** 확인됨: `data/반도체/두산테스나/tech/doosan_tesna_tech_to_value_inputs.json`
| 항목 | 값 | 해석 |
|---|---:|---|
...
- **산출물 상태:** 확인됨: `data/반도체/두산테스나/tech/doosan_tesna_tech_patent_evidence.json`
| 원천 신호 | 값 |
|---|---:|
...
| 대표 특허 예시 | 상태/연도 |
|---|---|
| 생체인식여권을 이용한 출입국 관리시스템 | 등록 |
| 전자여권용 인레이시트의 가공장치 | 등록 |
| 여권표지 | 등록 |
| 트랜스폰더 칩 및 이에 대응되는 인레이 기판에 안테나 연결시 생성되는 용접 탄화물의 제거방법 | 소멸 |
| 인레이 시트 가공장치 및 그 인레이 시트 가공방법 | 소멸 |
## Step 4. Patent KMeans clustering
- **산출물 상태:** 확인됨: `data/반도체/두산테스나/tech/tech_ml_signal.json`
| 항목 | 값 |
|---|---:|
| 모델 | tfidf_kmeans |
| 정규화 특허 텍스트 레코드 | 6건 |
...
|---:|---:|---|---|
| 0 | 3건 | 속표지, 속표지 40, 장착된, 출입국 | 기술 텍스트 유사도 기반 클러스터 |
| 1 | 3건 | 인레이, 안테나, 용접, 인레이 시트, 시트 | 기술 텍스트 유사도 기반 클러스터 |
...
- **산출물 상태:** 확인됨: `data/반도체/두산테스나/tech/tech_ip_ml.json`
### 9-1. Tech/IP Strength Index
| 항목 | 값 | 해석 |
|---|---:|---|
| Tech/IP Strength Index | 59.21/100 | 특허 등록률·존속성·최근성·IPC/CPC 다양성·핵심기술 키워드 밀도 점수를 통합한 IP 강도 지표입니다. |
| Reference Universe Percentile | 50.00% | reference universe 안에서의 상대적 기술/IP 위치입니다. |
| Patent Momentum Score | 97.63/100 | 최근 특허 활동과 기술 포트폴리오 지속성을 반영합니다. |
...
### 9-4. 해석
- doosan_tesna의 Tech/IP Strength Index는 59.21/100, percentile 50.0로 산출되어 중간 수준 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
...
### 10-5. 해석
- 두산테스나의 Technology Differentiation Score는 peer 대비 기술/IP 포트폴리오 차별성 신호입니다.
...
| 구분 | 경로 | 상태 |
|---|---|---|
| chair_summary | `data/반도체/두산테스나/tech/tech_chair_summary.json` | 확인됨 |
| tech_packet | `data/반도체/두산테스나/tech/tech.json` | 확인됨 |
| high_quality_md | `data/반도체/두산테스나/tech/doosan_tesna_tech_high_quality_report.md` | 확인됨 |
| tech_to_value | `data/반도체/두산테스나/tech/doosan_tesna_tech_to_value_inputs.json` | 확인됨 |
| patent_json | `data/반도체/두산테스나/tech/doosan_tesna_tech_patent_evidence.json` | 확인됨 |
| ml_signal | `data/반도체/두산테스나/tech/tech_ml_signal.json` | 확인됨 |
...
| tech_ip_ml | `data/반도체/두산테스나/tech/tech_ip_ml.json` | 확인됨 |
