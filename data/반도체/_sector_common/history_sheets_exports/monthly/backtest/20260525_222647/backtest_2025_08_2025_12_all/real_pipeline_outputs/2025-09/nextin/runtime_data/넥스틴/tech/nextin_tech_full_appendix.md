# 넥스틴 Tech Agent Full Appendix

- **생성 시각:** 2026-05-26T06:58:11
...
- **산출물 상태:** 확인됨: `data/반도체/넥스틴/tech/nextin_tech_high_quality_report.md`
...
| 활용 및 확장 산업 | 활용 산업 | 3 / 5 (확장성) | # 넥스틴 Tech Local Proxy Evidence; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 3건 | 중 | data\반도체\넥스틴\tech\source\nextin_tech_local_proxy_evidence.md |
...
- **산출물 상태:** 확인됨: `data/반도체/넥스틴/tech/nextin_tech_to_value_inputs.json`
| 항목 | 값 | 해석 |
|---|---:|---|
...
- **산출물 상태:** 확인됨: `data/반도체/넥스틴/tech/nextin_tech_patent_evidence.json`
| 원천 신호 | 값 |
|---|---:|
...
| 대표 특허 예시 | 상태/연도 |
|---|---|
| 반도체 기판의 정전기 제거 장치 | 등록 |
| 반도체 소자의 결함 검사를 위한 미세 케어 영역의 분할 방법 | 등록 |
| 웨이퍼 검사 광학계 | 등록 |
| 반도체 웨이퍼 주변부 파티클 검사방법 | 등록 |
| 웨이퍼 영상 검사 장치 | 등록 |
## Step 4. Patent KMeans clustering
- **산출물 상태:** 확인됨: `data/반도체/넥스틴/tech/tech_ml_signal.json`
| 항목 | 값 |
|---|---:|
| 모델 | tfidf_kmeans |
| 정규화 특허 텍스트 레코드 | 30건 |
...
|---:|---:|---|---|
| 1 | 13건 | 웨이퍼, 영상을, 영상, 검사, 패턴, 기판, 웨이퍼 영상, 웨이퍼 영상을 | 기술 텍스트 유사도 기반 클러스터 |
| 0 | 11건 | 트랩된, 진공, 챔버, 반도체 | 기술 텍스트 유사도 기반 클러스터 |
| 2 | 6건 | 결함, 암시야, 검사, 데이터, 반도체의, 암시야 검사 | 기술 텍스트 유사도 기반 클러스터 |
...
- **산출물 상태:** 확인됨: `data/반도체/넥스틴/tech/tech_ip_ml.json`
### 9-1. Tech/IP Strength Index
| 항목 | 값 | 해석 |
|---|---:|---|
| Tech/IP Strength Index | 57.01/100 | 특허 등록률·존속성·최근성·IPC/CPC 다양성·핵심기술 키워드 밀도 점수를 통합한 IP 강도 지표입니다. |
| Reference Universe Percentile | 50.00% | reference universe 안에서의 상대적 기술/IP 위치입니다. |
| Patent Momentum Score | 85.84/100 | 최근 특허 활동과 기술 포트폴리오 지속성을 반영합니다. |
...
### 9-4. 해석
- nextin의 Tech/IP Strength Index는 57.01/100, percentile 50.0로 산출되어 중간 수준 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
...
### 10-5. 해석
- 넥스틴의 Technology Differentiation Score는 peer 대비 기술/IP 포트폴리오 차별성 신호입니다.
...
| 구분 | 경로 | 상태 |
|---|---|---|
| chair_summary | `data/반도체/넥스틴/tech/tech_chair_summary.json` | 확인됨 |
| tech_packet | `data/반도체/넥스틴/tech/tech.json` | 확인됨 |
| high_quality_md | `data/반도체/넥스틴/tech/nextin_tech_high_quality_report.md` | 확인됨 |
| tech_to_value | `data/반도체/넥스틴/tech/nextin_tech_to_value_inputs.json` | 확인됨 |
| patent_json | `data/반도체/넥스틴/tech/nextin_tech_patent_evidence.json` | 확인됨 |
| ml_signal | `data/반도체/넥스틴/tech/tech_ml_signal.json` | 확인됨 |
...
| tech_ip_ml | `data/반도체/넥스틴/tech/tech_ip_ml.json` | 확인됨 |
...
- kipris_tech_ml_score: 53.89
- legal_stability_score_estimated: 87.0
- portfolio_momentum_score: 35.63
- ip_technology_fit_score: 28.0
...
- alive_patents_estimated: 22
- recent_5y_application_patents: 14
