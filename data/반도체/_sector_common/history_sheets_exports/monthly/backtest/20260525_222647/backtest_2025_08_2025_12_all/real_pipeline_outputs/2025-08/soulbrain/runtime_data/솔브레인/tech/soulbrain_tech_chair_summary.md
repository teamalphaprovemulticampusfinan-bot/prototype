...
| 근거 직접성·충분성 | 67.00 | 0.15 | 10.05 | Chair가 개인투자자에게 설명할 수 있는 근거의 직접성 |
| 사업화·성장자금 지속성 | 41.50 | 0.10 | 4.15 | R&D·특허·정부과제·기술이전·CAPEX/희석성 자금조달이 사업화와 연결되는 정도 |

### 2) 핵심 해석
- 솔브레인의 개인투자자용 Tech 최종 점수는 51.84/100이며, 판정은 기술 또는 IP 근거가 초기/제한적이어서 보수적 해석 필요입니다.
- 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(38.0)와 IP Evidence(44.69) 및 Excel 기반 정량 근거(90.0)를 함께 반영했습니다.
...
| tech.inv.ev.007 | tech_summary | **Tech Agent 핵심 해석**: 솔브레인의 개인투자자용 Tech 최종 점수는 51.84/100이며, 판정은 기술 또는 IP 근거가 초기/제한적이어서 보수적 해석 필요입니다. | - | 중 |
| tech.inv.ev.008 | tech_summary | **Tech Agent 핵심 해석**: 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(38.0)와 IP Evidence(44.69) 및 Excel 기반 정량 근거(90.0)를 함께 반영했습니다. | - | 중 |
