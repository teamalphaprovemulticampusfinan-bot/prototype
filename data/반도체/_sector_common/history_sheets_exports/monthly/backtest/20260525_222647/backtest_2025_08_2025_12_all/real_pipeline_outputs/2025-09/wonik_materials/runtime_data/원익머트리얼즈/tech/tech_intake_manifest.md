# Tech Intake Manifest - 원익머트리얼즈 (wonik_materials)

- status: READY_WITHOUT_AGENT
- source_csv: data/반도체/원익머트리얼즈/tech/wonik_materials_kipris_bibliographic_normalized.csv
- kipris_plus_network_enabled: False
- kipris_mode: existing_local_or_common_data
- required_missing: []

## Steps
- build_tech_excel_quantified_metrics: DONE (0)
