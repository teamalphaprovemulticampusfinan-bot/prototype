# 어보브반도체 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 53.06
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 74.91 | 18.73 | OK | IP_LEGAL_STABILITY_NEUTRAL_POSITIVE |
| claim_defense | 청구항 방어 범위 | 0.3 | 55.82 | 16.75 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 38.33 | 9.58 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 40.0 | 8.0 | OK | IP_GLOBAL_EXTENSION_NEUTRAL |
