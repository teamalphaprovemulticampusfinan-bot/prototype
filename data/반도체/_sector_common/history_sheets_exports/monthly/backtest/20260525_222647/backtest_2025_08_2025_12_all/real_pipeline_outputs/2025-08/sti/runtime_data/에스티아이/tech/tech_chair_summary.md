...
### 2) 핵심 해석
- 에스티아이의 개인투자자용 Tech 최종 점수는 65.17/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다.
...
| ID | 출처 | 근거 | 값 | 강도 |
|---|---|---|---:|---|
| tech.inv.ev.001 | tech_to_value | **최종 Tech-to-Value Bridge**: 에스티아이의 최종 기술-사업화 연결 점수는 22.0이며, Chair에는 기술성보다 고객 채택·양산·매출 전환 가능성을 우선 반영합니다. | 22.0점 | 상 |
...
| tech.inv.ev.012 | tech_summary | **Tech Agent 핵심 해석**: 에스티아이의 개인투자자용 Tech 최종 점수는 65.17/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다. | - | 중 |
...
### 매출 전환
- [DIRECT_EVIDENCE] summary: 에스티아이의 2023년 매출은 전년 대비 감소했으나, 2024년에는 소폭 반등하며 회복세를 보였다. (source=data/반도체/에스티아이/finance/에스티아이_finance.json, keywords=매출, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] key_thesis: 2024년 매출성장률이 4.56%로 플러스 전환되며 2023년의 역성장에서 벗어났다. (source=data/반도체/에스티아이/finance/에스티아이_finance.json, keywords=매출, 성장, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
...
### 마진·원가·현금흐름 연결
- [DIRECT_EVIDENCE] 영업이익률은 7~8% 수준을 유지하고 있으며, ROE는 10% 내외로 소폭 등락하고 있다. (source=data/반도체/에스티아이/finance/에스티아이_finance.json, keywords=영업이익률, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] 2024년에는 설비투자(CAPEX) 증가와 함께 잉여현금흐름(FCF)이 마이너스로 전환되었으며, 부채비율은 33%에서 41%로 상승했다. (source=data/반도체/에스티아이/finance/에스티아이_finance.json, keywords=현금흐름, FCF, CAPEX, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] key_thesis: 영업이익률이 7.5%~8.2% 수준으로 비교적 안정적으로 유지되고 있다. (source=data/반도체/에스티아이/finance/에스티아이_finance.json, keywords=영업이익률, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] key_thesis: 2022년 700억 원 이상이었던 잉여현금흐름(FCF)이 2024년에는 -234억 원으로 감소했다. (source=data/반도체/에스티아이/finance/에스티아이_finance.json, keywords=현금흐름, FCF, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] key_risks: 2024년 설비투자(CAPEX)가 181억 원으로 전년 대비 크게 증가하며 잉여현금흐름(FCF)이 마이너스로 전환되었다. (source=data/반도체/에스티아이/finance/에스티아이_finance.json, keywords=현금흐름, FCF, CAPEX, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
