# LX세미콘 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 61.14
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 74.33 | 18.58 | OK | IP_LEGAL_STABILITY_NEUTRAL |
| claim_defense | 청구항 방어 범위 | 0.3 | 53.16 | 15.95 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 45.0 | 11.25 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 76.78 | 15.36 | OK | IP_GLOBAL_EXTENSION_STRONG_POSITIVE |
