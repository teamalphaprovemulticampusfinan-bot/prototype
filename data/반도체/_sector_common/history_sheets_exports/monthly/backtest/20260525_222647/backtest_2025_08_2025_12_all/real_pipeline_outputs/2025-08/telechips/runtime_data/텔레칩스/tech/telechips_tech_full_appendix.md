# 텔레칩스 Tech Agent Full Appendix

- **생성 시각:** 2026-05-25T23:48:47
...
- **산출물 상태:** 확인됨: `data/반도체/텔레칩스/tech/telechips_tech_high_quality_report.md`
...
| 핵심 제품/서비스 | 제품명/서비스명 | 3 / 5 (수익성 기여) | 텔레칩스은 Universe CSV에서 '차량용 반도체' peer_group으로 분류되어 있습니다.; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 ... | 중 | data\반도체\텔레칩스\tech\source\telechips_tech_local_proxy_evidenc... |
...
| 활용 및 확장 산업 | 활용 산업 | 3 / 5 (확장성) | # 텔레칩스 Tech Local Proxy Evidence; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 3건 | 중 | data\반도체\텔레칩스\tech\source\telechips_tech_local_proxy_evidenc... |
...
- **산출물 상태:** 확인됨: `data/반도체/텔레칩스/tech/telechips_tech_to_value_inputs.json`
| 항목 | 값 | 해석 |
|---|---:|---|
...
- **산출물 상태:** 확인됨: `data/반도체/텔레칩스/tech/telechips_tech_patent_evidence.json`
| 원천 신호 | 값 |
|---|---:|
...
| 대표 특허 예시 | 상태/연도 |
|---|---|
| 전원 관리 장치 및 그 동작 방법 | 등록 |
| 더블 토크 이득 제어 장치 및 그 방법 | 등록 |
| 안드로이드 오토모티브 오디오 시스템 및 이를 이용한 스트림 변환 방법 | 등록 |
| 다채널 차량 블랙박스 및 녹화 파일 생성 방법 | 등록 |
| 다양한 영상 모드를 지원하는 이미지 스케일링 시스템 및 그 방법 | 등록 |
## Step 4. Patent KMeans clustering
- **산출물 상태:** 확인됨: `data/반도체/텔레칩스/tech/tech_ml_signal.json`
| 항목 | 값 |
|---|---:|
| 모델 | tfidf_kmeans |
| 정규화 특허 텍스트 레코드 | 30건 |
...
|---:|---:|---|---|
| 1 | 17건 | 영상, 이미지, 차량, 복수의 | 기술 텍스트 유사도 기반 클러스터 |
| 2 | 9건 | 신호, 펄스, 오디오, 신호를, 싱크, 데이터, 이득, 에러 | 기술 텍스트 유사도 기반 클러스터 |
| 0 | 4건 | 하드웨어, 복소수, 음향, 이동형, 좌표, 위성, 부동, 수신기 | 기술 텍스트 유사도 기반 클러스터 |
...
- **산출물 상태:** 확인됨: `data/반도체/텔레칩스/tech/tech_ip_ml.json`
### 9-1. Tech/IP Strength Index
| 항목 | 값 | 해석 |
|---|---:|---|
| Tech/IP Strength Index | 57.75/100 | 특허 등록률·존속성·최근성·IPC/CPC 다양성·핵심기술 키워드 밀도 점수를 통합한 IP 강도 지표입니다. |
| Reference Universe Percentile | 50.00% | reference universe 안에서의 상대적 기술/IP 위치입니다. |
| Patent Momentum Score | 85.62/100 | 최근 특허 활동과 기술 포트폴리오 지속성을 반영합니다. |
...
### 9-4. 해석
- telechips의 Tech/IP Strength Index는 57.75/100, percentile 50.0로 산출되어 중간 수준 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
...
### 10-5. 해석
- 텔레칩스의 Technology Differentiation Score는 peer 대비 기술/IP 포트폴리오 차별성 신호입니다.
...
| 구분 | 경로 | 상태 |
|---|---|---|
| chair_summary | `data/반도체/텔레칩스/tech/tech_chair_summary.json` | 확인됨 |
| tech_packet | `data/반도체/텔레칩스/tech/tech.json` | 확인됨 |
| high_quality_md | `data/반도체/텔레칩스/tech/telechips_tech_high_quality_report.md` | 확인됨 |
| tech_to_value | `data/반도체/텔레칩스/tech/telechips_tech_to_value_inputs.json` | 확인됨 |
| patent_json | `data/반도체/텔레칩스/tech/telechips_tech_patent_evidence.json` | 확인됨 |
| ml_signal | `data/반도체/텔레칩스/tech/tech_ml_signal.json` | 확인됨 |
...
| tech_ip_ml | `data/반도체/텔레칩스/tech/tech_ip_ml.json` | 확인됨 |
