# 티씨케이 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 54.9
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 79.41 | 19.85 | OK | IP_LEGAL_STABILITY_NEUTRAL_POSITIVE |
| claim_defense | 청구항 방어 범위 | 0.3 | 55.77 | 16.73 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 34.33 | 8.58 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 48.67 | 9.73 | OK | IP_GLOBAL_EXTENSION_NEUTRAL |
