# 넥스틴 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 54.51
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 83.67 | 20.92 | OK | IP_LEGAL_STABILITY_STRONG_POSITIVE |
| claim_defense | 청구항 방어 범위 | 0.3 | 58.02 | 17.41 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 43.67 | 10.92 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 26.33 | 5.27 | OK | IP_GLOBAL_EXTENSION_WEAK |
