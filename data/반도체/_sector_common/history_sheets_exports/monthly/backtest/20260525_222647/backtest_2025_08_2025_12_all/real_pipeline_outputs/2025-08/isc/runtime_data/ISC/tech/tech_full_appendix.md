...
- 투자자가 확인할 핵심 근거는 11개로 정리했으며, 중복 뉴스·중복 항목은 제외했습니다.
...
### 9-4. 해석
- isc의 Tech/IP Strength Index는 0.0/100, percentile 50.0로 산출되어 근거 보강 필요 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
