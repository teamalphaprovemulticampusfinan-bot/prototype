...
| IP Legal Stability | 57.32/100 | 등록률·존속률·소멸/거절/취하 비중 기반 권리 안정성 |
| IP Claim Defense | 57.71/100 | 청구항 수·독립항 수·수집 커버리지 기반 특허 방어력 |
| IP Citation Impact | 확인 제한 | 피인용·외부인용 기반 기술 영향력/시장 참조 가치 |
| IP Global Extension | 67.07/100 | 해외 패밀리·PCT/WO·미국/일본/유럽/중국 확장성 |
| IP Evidence Composite | 52.69/100 | 법적 안정성·청구항·인용·패밀리 특허를 통합한 종합 IP 근거 점수 |
...
| 원천 신호 | 값 |
|---|---:|
| 정규화 특허 텍스트 레코드 | 11,706건 |
| 회사 출원인/권리자 매칭 | 6,842건 |
| 등록 특허 | 1,729건 |
| 존속 가능 특허 | 3,551건 |
| 최근 5년 특허 | 1,560건 |
| IPC/CPC 다양성 | 17개 |
...
| KIPRIS 등록률(추정) | 75.13% |
| 등록특허 중 존속률(추정) | 50.87% |
| 소멸·거절·취하 등 부정 처분 비중(추정) | 58.90% |
| 권리자 정보 반영률 | 100.00% |
| 초록/도면 반영률 | 100.00% / 99.74% |
| 청구항 수집 커버리지 | 98.69% |
| 수집 청구항 / 독립항(추정) | 4,498항 / 990항 |
| 특허당 평균 청구항 / 독립항 비중 | 11.93항 / 22.01% |
| 피인용 총합 / 외부 피인용 | 확인 제한 / 확인 제한 |
| 외부 피인용률 | 확인 제한 |
| 해외 패밀리 보유율 | 61.26% |
| PCT/WO / US / JP / EP / CN | 142건 / 199건 / 172건 / 109건 / 150건 |

## 5. IP Evidence Composite 세부 구성
| 구성 요소 | Weight | Score | Contribution | Status |
|---|---:|---:|---:|---|
| 등록·존속 안정성 | 0.25 | 57.32/100 | 14.33점 | OK |
| 청구항 방어 범위 | 0.3 | 57.71/100 | 17.31점 | OK |
| 인용 기반 기술 영향력 | 0.25 | 30.55/100 | 7.64점 | OK |
| 해외 패밀리 기반 글로벌 확장성 | 0.2 | 67.07/100 | 13.41점 | OK |
...
- IP Evidence Composite Score: **52.69 / 100**
...
|---|---|---:|---:|---:|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 57.32 | 14.33 | OK |
| claim_defense | 청구항 방어 범위 | 0.3 | 57.71 | 17.31 | OK |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 30.55 | 7.64 | OK |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 67.07 | 13.41 | OK |
...
- IP Evidence Composite Score: 52.69
...
- Source: `C:/Agent_6.9/data/반도체/테스/tech/tech_ip_evidence_composite.json`
...
| IP Evidence Composite | 52.69 | 0.20 | 10.54 | 권리 안정성·청구항·인용·패밀리 기반 특허 품질 |
| Excel 기반 정량 근거 | 75.00 | 0.15 | 11.25 | 템플릿/수식 기준에 맞춰 실제 기업별 근거가 얼마나 채워졌는지 |
| 근거 직접성·충분성 | 76.00 | 0.15 | 11.40 | Chair가 개인투자자에게 설명할 수 있는 근거의 직접성 |
| 사업화·성장자금 지속성 | 63.50 | 0.10 | 6.35 | R&D·특허·정부과제·기술이전·CAPEX/희석성 자금조달이 사업화와 연결되는 정도 |

### 2) 핵심 해석
- 테스의 개인투자자용 Tech 최종 점수는 55.14/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다.
- 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(39.0)와 IP Evidence(52.69) 및 Excel 기반 정량 근거(75.0)를 함께 반영했습니다.
- 투자자가 확인할 핵심 근거는 9개로 정리했으며, 중복 뉴스·중복 항목은 제외했습니다.

### 3) 개인투자자가 확인할 근거
| ID | 출처 | 근거 | 값 | 강도 |
|---|---|---|---:|---|
| tech.inv.ev.001 | tech_to_value | **최종 Tech-to-Value Bridge**: 테스의 최종 기술-사업화 연결 점수는 39.0이며, Chair에는 기술성보다 고객 채택·양산·매출 전환 가능성을 우선 반영합니다. | 39.0점 | 상 |
| tech.inv.ev.002 | kipris_ip_evidence | **IP Evidence Composite**: 법적 안정성·청구항 방어력·인용 영향력·해외 패밀리 확장성을 합성한 IP Evidence Composite Score는 52.69입니다. | 52.69점 | 상 |
| tech.inv.ev.003 | kipris_legal | **권리 안정성**: 등록률 0.7513, 존속률 0.5087, 권리 안정성 점수 57.32를 확인했습니다. | 57.32점 | 중 |
| tech.inv.ev.004 | kipris_claim | **청구항 방어력**: 청구항 수 4498, 독립항 추정 990, claim defense score 57.71입니다. | 57.71점 | 중 |
| tech.inv.ev.005 | kipris_citation | **인용 영향력**: 전방/후방 인용 및 기술 영향력 점수 기준 IP_CITATION_FALLBACK_ESTIMATED입니다. | - | 중 |
| tech.inv.ev.006 | kipris_family | **글로벌 패밀리 확장성**: 해외 패밀리 비중 0.6126, 감지 지역 ['CN', 'EP', 'JP', 'US', 'WO'], global extension score 67.07입니다. | 67.07점 | 중 |
| tech.inv.ev.007 | tech_summary | **Tech Agent 핵심 해석**: 테스의 개인투자자용 Tech 최종 점수는 55.14/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다. | - | 중 |
| tech.inv.ev.008 | tech_summary | **Tech Agent 핵심 해석**: 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(39.0)와 IP Evidence(52.69) 및 Excel 기반 정량 근거(75.0)를 함께 반영했습니다. | - | 중 |
...
### 매출 전환
- [DIRECT_EVIDENCE] summary: 테스는 2023년 매출이 큰 폭으로 감소하며 영업이익이 적자 전환했으나, 2024년에는 매출이 60% 이상 반등하며 영업이익도 흑자 전환했다. (source=data/반도체/테스/finance/테스_finance.json, keywords=매출, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] key_thesis: 2024년 매출성장률이 63.4%로 크게 반등하며 이전의 역성장에서 벗어나는 모습을 보였다. (source=data/반도체/테스/finance/테스_finance.json, keywords=매출, 성장, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
...
### 마진·원가·현금흐름 연결
- [DIRECT_EVIDENCE] 2024년 ROE는 12.9%로 개선되었으나, 같은 해 자유현금흐름(FCF)은 대규모 설비투자(CAPEX)로 인해 마이너스를 기록했다. (source=data/반도체/테스/finance/테스_finance.json, keywords=현금흐름, FCF, CAPEX, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] key_thesis: 2024년 영업이익률이 16.0%로 개선되었으며, 2023년의 마이너스에서 흑자 전환에 성공했다. (source=data/반도체/테스/finance/테스_finance.json, keywords=영업이익률, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] key_thesis: 2024년 ROE가 12.9%로 상승하며 자본 대비 수익성이 개선되는 추세를 나타냈다. (source=data/반도체/테스/finance/테스_finance.json, keywords=수익성, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] key_risks: 2024년 자유현금흐름(FCF)이 -243억 원으로 마이너스를 기록했으며, 이는 대규모 설비투자(CAPEX) 548억 원에 기인한다. (source=data/반도체/테스/finance/테스_finance.json, keywords=현금흐름, FCF, CAPEX, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
- [DIRECT_EVIDENCE] key_risks: 2023년 영업이익률이 -3.99%로 마이너스를 기록하며 수익성 악화가 있었던 점을 고려해야 한다. (source=data/반도체/테스/finance/테스_finance.json, keywords=영업이익률, 수익성, urls=https://dart.fss.or.kr/, https://opendart.fss.or.kr/)
...
- source_patent_csv: `data\반도체\테스\tech\tes_kipris_bibliographic_normalized.csv`
