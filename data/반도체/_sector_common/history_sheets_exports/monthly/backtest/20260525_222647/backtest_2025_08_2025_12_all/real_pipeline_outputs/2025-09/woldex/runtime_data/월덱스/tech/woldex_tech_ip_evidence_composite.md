# 월덱스 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 50.18
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 67.17 | 16.79 | OK | IP_LEGAL_STABILITY_NEUTRAL_POSITIVE |
...
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 27.67 | 5.53 | OK | IP_GLOBAL_EXTENSION_WEAK |
