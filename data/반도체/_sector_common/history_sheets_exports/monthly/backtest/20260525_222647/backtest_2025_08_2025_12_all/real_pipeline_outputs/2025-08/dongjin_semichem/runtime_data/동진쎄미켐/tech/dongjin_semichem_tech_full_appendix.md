# 동진쎄미켐 Tech Agent Full Appendix

- **생성 시각:** 2026-05-26T01:38:53
...
- **산출물 상태:** 확인됨: `data/반도체/동진쎄미켐/tech/dongjin_semichem_tech_high_quality_report.md`
- **의미:** 기존 Excel 틀(high_quality_report.py)의 대분류를 Tech Agent 소유 풀버전 부록으로 옮긴 영역입니다.

| 대분류 | 항목 | 정량화 | 핵심 근거 | 등급 | 비고 |
|---|---|---:|---|---|---|
| 대표 기술 | 핵심 기술 키워드 | 4 / 5 (기술성) | 동진쎄미켐은 Universe CSV에서 '소재' peer_group으로 분류되어 있습니다.; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 4... | 강 | data\반도체\동진쎄미켐\tech\source\dongjin_semichem_tech_local_proxy... |
| 핵심 제품/서비스 | 제품명/서비스명 | 2 / 5 (수익성 기여) | 핵심 원천 근거 추가 필요; 직접근거 1건, 공식/DART/IR/특허 근거 0건, 정량화 지표 5건 | 보강 필요 | - |
...
| 활용 및 확장 산업 | 활용 산업 | 3 / 5 (확장성) | # 동진쎄미켐 Tech Local Proxy Evidence; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 3건 | 중 | data\반도체\동진쎄미켐\tech\source\dongjin_semichem_tech_local_proxy... |
...
- **산출물 상태:** 확인됨: `data/반도체/동진쎄미켐/tech/dongjin_semichem_tech_to_value_inputs.json`
| 항목 | 값 | 해석 |
|---|---:|---|
...
- **산출물 상태:** 확인됨: `data/반도체/동진쎄미켐/tech/dongjin_semichem_tech_patent_evidence.json`
| 원천 신호 | 값 |
|---|---:|
...
| 대표 특허 예시 | 상태/연도 |
|---|---|
| 태양 전지 및 이를 형성하는 방법 | 등록 |
| 포토레지스트 제거용 씬너 조성물 | 소멸 |
| 신규한 캡핑층용 화합물 및 이를 포함하는 유기 발광 소자 | 등록 |
| 포토레지스트 제거용 씬너 조성물 | 소멸 |
| 감광성 고분자, 이를 이용한 포토레지스트 조성물 및 패턴형성 방법 | 등록 |
## Step 4. Patent KMeans clustering
- **산출물 상태:** 확인됨: `data/반도체/동진쎄미켐/tech/tech_ml_signal.json`
| 항목 | 값 |
|---|---:|
| 모델 | tfidf_kmeans |
| 정규화 특허 텍스트 레코드 | 102건 |
...
|---:|---:|---|---|
| 2 | 34건 | 내지, 중량, 포토레지스트, 금속, 화합물 | 기술 텍스트 유사도 기반 클러스터 |
| 1 | 15건 | 유기, 유기 발광, 발광, 포함하는 유기, 소자에, 발광 소자에 | 기술 텍스트 유사도 기반 클러스터 |
| 7 | 14건 | 감광성, 수지, 감광성 수지, 수지 조성물, 수지 조성물에, 불포화, 조성물에 | 기술 텍스트 유사도 기반 클러스터 |
| 0 | 11건 | 산화, 금속막, 형성용 전구체, 전구체 화합물, 전구체 | 기술 텍스트 유사도 기반 클러스터 |
| 3 | 10건 | 박리액, 포토레지스트, 포토레지스트 박리액, 박리액 조성물, 조성물에 관한, 조성물에 | 기술 텍스트 유사도 기반 클러스터 |
| 6 | 8건 | 캡핑층용 화합물, 발광, 캡핑층용, 유기 발광 | 기술 텍스트 유사도 기반 클러스터 |
| 4 | 6건 | 레지스트, 레지스트 제거용, 제거용, 중량, 세정액, 제거용 조성물, 패턴된 | 기술 텍스트 유사도 기반 클러스터 |
| 5 | 4건 | 씬너, 제거용 씬너, 포토레지스트 제거용, 기판, 제거용, 사용되는, 알킬, 포토레지스트 | 기술 텍스트 유사도 기반 클러스터 |
...
- **산출물 상태:** 확인됨: `data/반도체/동진쎄미켐/tech/tech_ip_ml.json`
### 9-1. Tech/IP Strength Index
| 항목 | 값 | 해석 |
|---|---:|---|
| Tech/IP Strength Index | 67.28/100 | 특허 등록률·존속성·최근성·IPC/CPC 다양성·핵심기술 키워드 밀도 점수를 통합한 IP 강도 지표입니다. |
| Reference Universe Percentile | 50.00% | reference universe 안에서의 상대적 기술/IP 위치입니다. |
| Patent Momentum Score | 63.87/100 | 최근 특허 활동과 기술 포트폴리오 지속성을 반영합니다. |
...
### 9-4. 해석
- dongjin_semichem의 Tech/IP Strength Index는 67.28/100, percentile 50.0로 산출되어 평균 이상 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
...
### 10-5. 해석
- 동진쎄미켐의 Technology Differentiation Score는 peer 대비 기술/IP 포트폴리오 차별성 신호입니다.
...
| 구분 | 경로 | 상태 |
|---|---|---|
| chair_summary | `data/반도체/동진쎄미켐/tech/tech_chair_summary.json` | 확인됨 |
| tech_packet | `data/반도체/동진쎄미켐/tech/tech.json` | 확인됨 |
| high_quality_md | `data/반도체/동진쎄미켐/tech/dongjin_semichem_tech_high_quality_report.md` | 확인됨 |
| tech_to_value | `data/반도체/동진쎄미켐/tech/dongjin_semichem_tech_to_value_inputs.json` | 확인됨 |
| patent_json | `data/반도체/동진쎄미켐/tech/dongjin_semichem_tech_patent_evidence.json` | 확인됨 |
| ml_signal | `data/반도체/동진쎄미켐/tech/tech_ml_signal.json` | 확인됨 |
...
| tech_ip_ml | `data/반도체/동진쎄미켐/tech/tech_ip_ml.json` | 확인됨 |
