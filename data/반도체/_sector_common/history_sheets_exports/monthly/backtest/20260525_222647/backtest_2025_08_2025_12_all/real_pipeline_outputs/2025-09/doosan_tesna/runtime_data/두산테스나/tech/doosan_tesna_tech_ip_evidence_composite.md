# 두산테스나 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 50.37
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 67.5 | 16.88 | OK | IP_LEGAL_STABILITY_NEUTRAL |
| claim_defense | 청구항 방어 범위 | 0.3 | 54.15 | 16.24 | OK | IP_CLAIM_SCOPE_NEUTRAL |
