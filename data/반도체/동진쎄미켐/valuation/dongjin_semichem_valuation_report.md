...
- DCF 내재주가: **해당 없음**
- 현재가 대비 괴리율: **확인 제한**
- Peer P/S: **1.22배** / Peer 중앙값 **3.43배**
- P/S 해석: **피어 대비 저PSR 구간: 상대 저평가 가능성**
- 208개 반도체 reference universe: **208개**, Target 그룹 **소재**
- Valuation 보조 스코어카드: **61.8/100 / 중립 이상**
- 종합 가치평가 점수: **68.6/100**
- 가치범위 중앙값/안전마진: **55,394원 / 2.0%**
- 역산 DCF 역산 영구성장률: **확인 제한**
- 오너 이익 주당가치/EPV: **30,763원 / 11,200원**
- 1년 수익률 / MDD / 변동성: **81.0% / -60.0% / 51.3%**
- 시가총액 / 발행주식 수 / 20일 평균 거래대금: **27,918.1억원 / 51414494.0주 / 562.6억원**
- ML 보조 가치평가 품질: **가치평가 보조근거 중립** (55.4/100)
- 검증 상태: **FAIL**
...
## 5. 주요 검증/주의사항
- [MEDIUM] MISSING_REVENUE: 최근 연도 revenue 값이 없습니다.
