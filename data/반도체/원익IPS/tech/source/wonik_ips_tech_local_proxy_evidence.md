# 원익IPS Tech Local Proxy Evidence

- company_name: 원익IPS
- company_slug: wonik_ips
- stock_code: 240810
- market: KOSDAQ
- peer_group: 장비
...
원익IPS은 Universe CSV에서 '장비' peer_group으로 분류되어 있습니다.
이 분류에 따라 Tech Agent는 다음 기술 후보 키워드를 우선 탐색합니다: 반도체, 공정, 양산, 고객, R&D, 특허, 기술경쟁력, 반도체 장비, 공정장비, 검사장비, 자동화, CAPEX.

## 대표 기술 후보

- 반도체 value chain 내 위치: 장비
