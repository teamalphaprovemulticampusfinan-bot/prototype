...
- **산출물 상태:** 확인됨: `data/반도체/원익IPS/tech/wonik_ips_tech_high_quality_report.md`
...
| 핵심 제품/서비스 | 제품명/서비스명 | 2 / 5 (수익성 기여) | 핵심 원천 근거 추가 필요; 직접근거 0건, 공식/DART/IR/특허 근거 0건, 정량화 지표 6건 | 보강 필요 | - |
...
| 활용 및 확장 산업 | 활용 산업 | 3 / 5 (확장성) | # 원익IPS Tech Local Proxy Evidence; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 3건 | 중 | data\반도체\원익IPS\tech\source\wonik_ips_tech_local_proxy_eviden... |
...
- **산출물 상태:** 확인됨: `data/반도체/원익IPS/tech/wonik_ips_tech_to_value_inputs.json`
| 항목 | 값 | 해석 |
|---|---:|---|
...
- **산출물 상태:** 확인됨: `data/반도체/원익IPS/tech/wonik_ips_tech_patent_evidence.json`
| 원천 신호 | 값 |
|---|---:|
...
| 대표 특허 예시 | 상태/연도 |
|---|---|
| 기판처리장치 및 이를 이용한 기판처리방법 | 등록 |
| 반도체 소자의 제조방법 | 등록 |
| 기판지지장치 및 이를 포함하는 기판처리장치 | 등록 |
| 박막 증착 장치, 이를 포함하는 기판 처리 시스템 및 박막 증착 방법 | 등록 |
| 실리콘 산화막 형성 방법 | 등록 |
## Step 4. Patent KMeans clustering
- **산출물 상태:** 확인됨: `data/반도체/원익IPS/tech/tech_ml_signal.json`
| 항목 | 값 |
|---|---:|
| 모델 | tfidf_kmeans |
| 정규화 특허 텍스트 레코드 | 116건 |
...
|---:|---:|---|---|
| 2 | 31건 | 보다, 기판처리장치에 관한 | 기술 텍스트 유사도 기반 클러스터 |
| 6 | 29건 | 공정, 기판, 가스, 처리 | 기술 텍스트 유사도 기반 클러스터 |
| 1 | 14건 | 복수의, 기판, 처리, 기판 처리, 가스, 처리 장치 | 기술 텍스트 유사도 기반 클러스터 |
| 3 | 11건 | 박막, 증착, 박막 증착, 진공, 증착 장치 | 기술 텍스트 유사도 기반 클러스터 |
| 7 | 9건 | 기판처리장치에, 히터, 기판처리장치에 관한, 히터 200 | 기술 텍스트 유사도 기반 클러스터 |
| 4 | 8건 | 반도체, 반도체 소자의, 소자의, 하드, 실리콘 | 기술 텍스트 유사도 기반 클러스터 |
| 0 | 7건 | 레이져, 가공, 레이져 가공, 단위 | 기술 텍스트 유사도 기반 클러스터 |
| 5 | 7건 | 도가니부 100, 도가니부, 증착물질, 리니어소스, 가지는, 그를 가지는, 그를 | 기술 텍스트 유사도 기반 클러스터 |
...
- **산출물 상태:** 확인됨: `data/반도체/원익IPS/tech/tech_ip_ml.json`
### 9-1. Tech/IP Strength Index
| 항목 | 값 | 해석 |
|---|---:|---|
| Tech/IP Strength Index | 39.80/100 | 특허 등록률·존속성·최근성·IPC/CPC 다양성·핵심기술 키워드 밀도 점수를 통합한 IP 강도 지표입니다. |
| Reference Universe Percentile | 50.00% | reference universe 안에서의 상대적 기술/IP 위치입니다. |
| Patent Momentum Score | 1.91/100 | 최근 특허 활동과 기술 포트폴리오 지속성을 반영합니다. |
...
### 9-4. 해석
- wonik_ips의 Tech/IP Strength Index는 39.8/100, percentile 50.0로 산출되어 근거 보강 필요 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
...
### 10-5. 해석
- 원익IPS의 Technology Differentiation Score는 peer 대비 기술/IP 포트폴리오 차별성 신호입니다.
...
| 구분 | 경로 | 상태 |
|---|---|---|
| chair_summary | `data/반도체/원익IPS/tech/tech_chair_summary.json` | 확인됨 |
| tech_packet | `data/반도체/원익IPS/tech/tech.json` | 확인됨 |
| high_quality_md | `data/반도체/원익IPS/tech/wonik_ips_tech_high_quality_report.md` | 확인됨 |
| tech_to_value | `data/반도체/원익IPS/tech/wonik_ips_tech_to_value_inputs.json` | 확인됨 |
| patent_json | `data/반도체/원익IPS/tech/wonik_ips_tech_patent_evidence.json` | 확인됨 |
| ml_signal | `data/반도체/원익IPS/tech/tech_ml_signal.json` | 확인됨 |
...
| tech_ip_ml | `data/반도체/원익IPS/tech/tech_ip_ml.json` | 확인됨 |
