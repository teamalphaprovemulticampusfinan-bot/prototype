# 원익IPS IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 47.02
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 62.35 | 15.59 | OK | IP_LEGAL_STABILITY_NEUTRAL |
| claim_defense | 청구항 방어 범위 | 0.3 | 55.01 | 16.5 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 40.52 | 10.13 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 24.02 | 4.8 | OK | IP_GLOBAL_EXTENSION_WEAK |
