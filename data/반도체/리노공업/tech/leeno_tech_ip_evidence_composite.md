# 리노공업 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 56.36
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 83.65 | 20.91 | OK | IP_LEGAL_STABILITY_STRONG_POSITIVE |
| claim_defense | 청구항 방어 범위 | 0.3 | 64.22 | 19.27 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 31.67 | 7.92 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 41.33 | 8.27 | OK | IP_GLOBAL_EXTENSION_NEUTRAL |
