# 유진테크 Tech Agent Full Appendix

- **생성 시각:** 2026-05-20T21:44:09
...
- **산출물 상태:** 확인됨: `data/반도체/유진테크/tech/eugene_tech_tech_high_quality_report.md`
...
| 활용 및 확장 산업 | 활용 산업 | 3 / 5 (확장성) | # 유진테크 Tech Local Proxy Evidence; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 3건 | 중 | data\반도체\유진테크\tech\source\eugene_tech_tech_local_proxy_evide... |
...
- **산출물 상태:** 확인됨: `data/반도체/유진테크/tech/eugene_tech_tech_to_value_inputs.json`
| 항목 | 값 | 해석 |
|---|---:|---|
...
- **산출물 상태:** 확인됨: `data/반도체/유진테크/tech/eugene_tech_tech_patent_evidence.json`
| 원천 신호 | 값 |
|---|---:|
| 정규화 특허 텍스트 레코드 | 421건 |
| 회사 출원인/권리자 매칭 | 255건 |
...
| 대표 특허 예시 | 상태/연도 |
|---|---|
| 기판 처리 장치 및 기판 처리 방법 | 등록 |
| 기판 처리장치 및 기판 처리방법 | 등록 |
| 기판 이송장치 및 기판 이송장치의 운용방법 | 등록 |
| 3차원 구조의 메모리 소자를 제조하는 장치 | 등록 |
| 전극 탭 처짐 방지 장치를 가지는 이차전지용 전극 노칭금형 | 등록 |
## Step 4. Patent KMeans clustering
- **산출물 상태:** 확인됨: `data/반도체/유진테크/tech/tech_ml_signal.json`
| 항목 | 값 |
|---|---:|
| 모델 | tfidf_kmeans |
| 정규화 특허 텍스트 레코드 | 21건 |
...
|---:|---:|---|---|
| 2 | 10건 | 기판, 처리, 기판 처리, 반응, 배치식 기판, 배치식 | 기술 텍스트 유사도 기반 클러스터 |
| 1 | 8건 | 스테이션, 공정, 금속, 공정 스테이션, 상부에 | 기술 텍스트 유사도 기반 클러스터 |
| 0 | 3건 | 전극, 전원, 전원 전극, 펀치, 다이, 내지 제2, 전극 내지 | 기술 텍스트 유사도 기반 클러스터 |
...
- **산출물 상태:** 확인됨: `data/반도체/유진테크/tech/tech_ip_ml.json`
### 9-1. Tech/IP Strength Index
| 항목 | 값 | 해석 |
|---|---:|---|
| Tech/IP Strength Index | 30.75/100 | 특허 등록률·존속성·최근성·IPC/CPC 다양성·핵심기술 키워드 밀도 점수를 통합한 IP 강도 지표입니다. |
| Reference Universe Percentile | 50.00% | reference universe 안에서의 상대적 기술/IP 위치입니다. |
| Patent Momentum Score | 3.24/100 | 최근 특허 활동과 기술 포트폴리오 지속성을 반영합니다. |
...
### 9-4. 해석
- eugene_tech의 Tech/IP Strength Index는 30.75/100, percentile 50.0로 산출되어 근거 보강 필요 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
...
### 10-5. 해석
- 유진테크의 Technology Differentiation Score는 peer 대비 기술/IP 포트폴리오 차별성 신호입니다.
...
| 구분 | 경로 | 상태 |
|---|---|---|
| chair_summary | `data/반도체/유진테크/tech/tech_chair_summary.json` | 확인됨 |
| tech_packet | `data/반도체/유진테크/tech/tech.json` | 확인됨 |
| high_quality_md | `data/반도체/유진테크/tech/eugene_tech_tech_high_quality_report.md` | 확인됨 |
| tech_to_value | `data/반도체/유진테크/tech/eugene_tech_tech_to_value_inputs.json` | 확인됨 |
| patent_json | `data/반도체/유진테크/tech/eugene_tech_tech_patent_evidence.json` | 확인됨 |
| ml_signal | `data/반도체/유진테크/tech/tech_ml_signal.json` | 확인됨 |
...
| tech_ip_ml | `data/반도체/유진테크/tech/tech_ip_ml.json` | 확인됨 |
