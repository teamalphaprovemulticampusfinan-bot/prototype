# 솔브레인 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 44.69
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 51.94 | 12.98 | OK | IP_LEGAL_STABILITY_NEUTRAL |
| claim_defense | 청구항 방어 범위 | 0.3 | 49.8 | 14.94 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 38.78 | 9.7 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 35.33 | 7.07 | OK | IP_GLOBAL_EXTENSION_NEUTRAL |
