# 에스티아이 Tech Agent Full Appendix

- **생성 시각:** 2026-05-20T22:08:52
...
- **산출물 상태:** 확인됨: `data/반도체/에스티아이/tech/sti_tech_high_quality_report.md`
...
| 활용 및 확장 산업 | 활용 산업 | 3 / 5 (확장성) | # 에스티아이 Tech Local Proxy Evidence; 직접근거 3건, 공식/DART/IR/특허 근거 0건, 정량화 지표 3건 | 중 | data\반도체\에스티아이\tech\source\sti_tech_local_proxy_evidence.md |
...
- **산출물 상태:** 확인됨: `data/반도체/에스티아이/tech/sti_tech_to_value_inputs.json`
| 항목 | 값 | 해석 |
|---|---:|---|
...
- **산출물 상태:** 확인됨: `data/반도체/에스티아이/tech/sti_tech_patent_evidence.json`
| 원천 신호 | 값 |
|---|---:|
| 정규화 특허 텍스트 레코드 | 1,023건 |
| 회사 출원인/권리자 매칭 | 607건 |
| 등록 특허 | 158건 |
| 존속 가능 특허 | 314건 |
| 최근 5년 특허 | 26건 |
...
|---|---|
| 캐리어 및 기판적재용 로봇암 | 등록 |
| 물류 로봇과 이를 포함하는 공정 자동화 시스템 | 등록 |
| 건식 세정 장치 | 등록 |
| 유체 이송용 커플러 | 등록 |
| 탄화규소 분말의 합성방법 | 등록 |
## Step 4. Patent KMeans clustering
- **산출물 상태:** 확인됨: `data/반도체/에스티아이/tech/tech_ml_signal.json`
| 항목 | 값 |
|---|---:|
| 모델 | tfidf_kmeans |
| 정규화 특허 텍스트 레코드 | 58건 |
...
|---:|---:|---|---|
| 2 | 21건 | 타겟교체용, 기판을, 위하여 | 기술 텍스트 유사도 기반 클러스터 |
| 3 | 16건 | 잉크젯, 헤드, 프린트, uv, 잉크젯 프린트, 프린팅 | 기술 텍스트 유사도 기반 클러스터 |
| 1 | 11건 | 기판, 공정, 레이저, 세정, 섹션 | 기술 텍스트 유사도 기반 클러스터 |
| 0 | 10건 | 커플링, 유체, 커플러, 포함하는 커플링, 식각 | 기술 텍스트 유사도 기반 클러스터 |
...
- **산출물 상태:** 확인됨: `data/반도체/에스티아이/tech/tech_ip_ml.json`
### 9-1. Tech/IP Strength Index
| 항목 | 값 | 해석 |
|---|---:|---|
| Tech/IP Strength Index | 26.73/100 | 특허 등록률·존속성·최근성·IPC/CPC 다양성·핵심기술 키워드 밀도 점수를 통합한 IP 강도 지표입니다. |
| Reference Universe Percentile | 50.00% | reference universe 안에서의 상대적 기술/IP 위치입니다. |
| Patent Momentum Score | 3.21/100 | 최근 특허 활동과 기술 포트폴리오 지속성을 반영합니다. |
...
### 9-4. 해석
- sti의 Tech/IP Strength Index는 26.73/100, percentile 50.0로 산출되어 근거 보강 필요 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
...
### 10-5. 해석
- 에스티아이의 Technology Differentiation Score는 peer 대비 기술/IP 포트폴리오 차별성 신호입니다.
...
| 구분 | 경로 | 상태 |
|---|---|---|
| chair_summary | `data/반도체/에스티아이/tech/tech_chair_summary.json` | 확인됨 |
| tech_packet | `data/반도체/에스티아이/tech/tech.json` | 확인됨 |
| high_quality_md | `data/반도체/에스티아이/tech/sti_tech_high_quality_report.md` | 확인됨 |
| tech_to_value | `data/반도체/에스티아이/tech/sti_tech_to_value_inputs.json` | 확인됨 |
| patent_json | `data/반도체/에스티아이/tech/sti_tech_patent_evidence.json` | 확인됨 |
| ml_signal | `data/반도체/에스티아이/tech/tech_ml_signal.json` | 확인됨 |
...
| tech_ip_ml | `data/반도체/에스티아이/tech/tech_ip_ml.json` | 확인됨 |
