# Auditor Valuation/Credit/ML Overlay - 엘티씨
...
- 신용위험 ML 판단: LOW_RISK
- 해석: 엘티씨는 반도체 딥테크 peer universe 내에서 가치평가 ML 판단은 ATTRACTIVE, 신용위험 ML 판단은 LOW_RISK로 분류된다.
- Auditor 판단: 최종 보고서에서는 성장성·저평가 가능성뿐 아니라 수익성, 현금흐름, 재무안정성 리스크도 함께 검토해야 한다.

## Credit Assessment
- signal: watch
- watch_grade: B
- risk_drivers: 영업이익률 -9.55%로 사업 수익성 미흡; 순이익률 -5.86%로 손실 흡수력 점검 필요; ROE -8.13%로 자본효율성 부진

## Valuation Assessment
- valuation_signal: valuation_neutral
- dcf_available: True
- ev_proxy_to_sales: 0.8239
- cautions: 영업이익률 -9.55%

## ML / Model-Risk Overlay
- trained_proxy_available: True
- trained_valuation_signal: ATTRACTIVE
- trained_valuation_confidence: 0.6353
- trained_credit_label: LOW_RISK
- trained_credit_confidence: 0.9205
- trained_credit_anomaly_score: 0.0039
...
- downside_risk_score: 0.3078
- upside_support_score: 0.6003
- peer_anomaly: 동종 샘플이 부족해 peer anomaly는 제한적으로만 해석합니다.

## Sources
- financial_csv=엘티씨_재무.csv
- stock_csv=엘티씨_주식.csv
- auditor_overlay_artifact=C:\Agent_6.8\data\반도체\엘티씨\auditor\first_auditor\valuation_credit_overlay.json
