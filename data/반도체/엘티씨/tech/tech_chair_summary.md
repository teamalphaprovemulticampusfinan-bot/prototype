...
## 1. Chair 반영용 핵심 판단
- **의견:** 매수
- **Tech-to-Value:** base 60.00/100 / 사업화 추적형(COMMERCIALIZATION_WATCH)
- **Peer-adjusted:** 84.00/100 / 사업화 추적형(COMMERCIALIZATION_WATCH)
- **IP Evidence Composite:** 35.48/100 / IP 근거 취약형(IP_EVIDENCE_WEAK)
...
| IP Legal Stability | 72.94/100 | 등록률·존속률·소멸/거절/취하 비중 기반 권리 안정성 |
...
| IP Evidence Composite | 35.48/100 | 법적 안정성·청구항·인용·패밀리 특허를 통합한 종합 IP 근거 점수 |
...
|---|---:|---:|---:|---|
| 등록·존속 안정성 | 0.25 | 72.94/100 | 18.23점 | OK |
...
- IP Evidence Composite Score: **35.48 / 100**
...
|---|---|---:|---:|---:|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 72.94 | 18.23 | OK |
...
- Source: `data/반도체/엘티씨/tech/tech_ip_evidence_composite.json`
...
| IP 품질 | 직접 근거 확인 | 50.96 | 4 | 0 | 0 | KIPRIS 기반 법적 상태·청구항·인용·패밀리 산출물을 함께 반영합니다. 특허 수량만이 아니라 권리 안정성, 청구항 방어력, 인용 영향력, 해외 확장성을 분리해 Chair 판단에 전달합니다. |
...
- [DIRECT_EVIDENCE] citations: status=COLLECTED, count=506, score=None, signal=None (source=data/반도체/엘티씨/tech/ltc_tech_ip_citation_features.json, keywords=citations, COLLECTED, urls=https://www.kipris.or.kr/khome/main.jsp, https://plus.kipris.or.kr/)
