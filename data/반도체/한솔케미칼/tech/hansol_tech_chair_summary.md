...
## 1. Chair 반영용 핵심 판단
- **의견:** 매수
- **Tech-to-Value:** base 67.00/100 / 사업화 추적형(COMMERCIALIZATION_WATCH)
- **Peer-adjusted:** 84.00/100 / 사업화 추적형(COMMERCIALIZATION_WATCH)
- **IP Evidence Composite:** 52.94/100 / IP 근거 중립형(IP_EVIDENCE_NEUTRAL)
...
| IP Legal Stability | 71.75/100 | 등록률·존속률·소멸/거절/취하 비중 기반 권리 안정성 |
| IP Claim Defense | 52.98/100 | 청구항 수·독립항 수·수집 커버리지 기반 특허 방어력 |
| IP Citation Impact | 확인 제한 | 피인용·외부인용 기반 기술 영향력/시장 참조 가치 |
| IP Global Extension | 39.30/100 | 해외 패밀리·PCT/WO·미국/일본/유럽/중국 확장성 |
| IP Evidence Composite | 52.94/100 | 법적 안정성·청구항·인용·패밀리 특허를 통합한 종합 IP 근거 점수 |
...
| 원천 신호 | 값 |
|---|---:|
| 정규화 특허 텍스트 레코드 | 11,787건 |
| 회사 출원인/권리자 매칭 | 8,623건 |
| 등록 특허 | 4,774건 |
| 존속 가능 특허 | 6,754건 |
| 최근 5년 특허 | 1,057건 |
| IPC/CPC 다양성 | 237개 |
...
| KIPRIS 등록률(추정) | 62.96% |
| 등록특허 중 존속률(추정) | 84.99% |
| 소멸·거절·취하 등 부정 처분 비중(추정) | 25.15% |
| 권리자 정보 반영률 | 100.00% |
| 초록/도면 반영률 | 100.00% / 85.98% |
| 청구항 수집 커버리지 | 100.00% |
| 수집 청구항 / 독립항(추정) | 5,310항 / 1,399항 |
| 특허당 평균 청구항 / 독립항 비중 | 8.09항 / 26.35% |
| 피인용 총합 / 외부 피인용 | 확인 제한 / 확인 제한 |
| 외부 피인용률 | 확인 제한 |
| 해외 패밀리 보유율 | 24.54% |
| PCT/WO / US / JP / EP / CN | 121건 / 77건 / 64건 / 49건 / 48건 |

## 5. IP Evidence Composite 세부 구성
| 구성 요소 | Weight | Score | Contribution | Status |
|---|---:|---:|---:|---|
| 등록·존속 안정성 | 0.25 | 71.75/100 | 17.94점 | OK |
| 청구항 방어 범위 | 0.3 | 52.98/100 | 15.89점 | OK |
| 인용 기반 기술 영향력 | 0.25 | 45.00/100 | 11.25점 | OK |
| 해외 패밀리 기반 글로벌 확장성 | 0.2 | 39.30/100 | 7.86점 | OK |
...
- IP Evidence Composite Score: **52.94 / 100**
...
|---|---|---:|---:|---:|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 71.75 | 17.94 | OK |
| claim_defense | 청구항 방어 범위 | 0.3 | 52.98 | 15.89 | OK |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 45.0 | 11.25 | OK |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 39.3 | 7.86 | OK |
...
- Source: `data/반도체/한솔케미칼/tech/tech_ip_evidence_composite.json`
...
| IP Evidence Composite | 52.94 | 0.20 | 10.59 | 권리 안정성·청구항·인용·패밀리 기반 특허 품질 |
...
### 2) 핵심 해석
- 한솔케미칼의 개인투자자용 Tech 최종 점수는 76.69/100이며, 판정은 기술의 가치전환 준비도는 높지만 일부 고객·매출·마진 근거는 추가 확인 필요입니다.
- 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(84.0)와 IP Evidence(52.94) 및 Excel 기반 정량 근거(85.0)를 함께 반영했습니다.
- 투자자가 확인할 핵심 근거는 9개로 정리했으며, 중복 뉴스·중복 항목은 제외했습니다.

### 3) 개인투자자가 확인할 근거
| ID | 출처 | 근거 | 값 | 강도 |
|---|---|---|---:|---|
| tech.inv.ev.001 | tech_to_value | **최종 Tech-to-Value Bridge**: 한솔케미칼의 최종 기술-사업화 연결 점수는 84.0이며, Chair에는 기술성보다 고객 채택·양산·매출 전환 가능성을 우선 반영합니다. | 84.0점 | 상 |
| tech.inv.ev.002 | kipris_ip_evidence | **IP Evidence Composite**: 법적 안정성·청구항 방어력·인용 영향력·해외 패밀리 확장성을 합성한 IP Evidence Composite Score는 52.94입니다. | 52.94점 | 상 |
| tech.inv.ev.003 | kipris_legal | **권리 안정성**: 등록률 0.6296, 존속률 0.8499, 권리 안정성 점수 71.75를 확인했습니다. | 71.75점 | 중 |
| tech.inv.ev.004 | kipris_claim | **청구항 방어력**: 청구항 수 5310, 독립항 추정 1399, claim defense score 52.98입니다. | 52.98점 | 중 |
| tech.inv.ev.005 | kipris_citation | **인용 영향력**: 전방/후방 인용 및 기술 영향력 점수 기준 IP_CITATION_FALLBACK_ESTIMATED입니다. | - | 중 |
| tech.inv.ev.006 | kipris_family | **글로벌 패밀리 확장성**: 해외 패밀리 비중 0.2454, 감지 지역 ['CN', 'EP', 'JP', 'US', 'WO'], global extension score 39.3입니다. | 39.3점 | 중 |
| tech.inv.ev.007 | tech_summary | **Tech Agent 핵심 해석**: 한솔케미칼의 개인투자자용 Tech 최종 점수는 76.69/100이며, 판정은 기술의 가치전환 준비도는 높지만 일부 고객·매출·마진 근거는 추가 확인 필요입니다. | - | 중 |
| tech.inv.ev.008 | tech_summary | **Tech Agent 핵심 해석**: 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(84.0)와 IP Evidence(52.94) 및 Excel 기반 정량 근거(85.0)를 함께 반영했습니다. | - | 중 |
