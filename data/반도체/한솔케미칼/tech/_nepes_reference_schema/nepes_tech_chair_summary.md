...
- **대상 기업:** 네패스
- **최종 Tech 점수:** 76.25/100
- **최종 판정:** 사업화 연결성이 확인되는 준비형 `TECH_TO_VALUE_READY`
- **해석 원칙:** 특허 수, 기술 키워드 수, 뉴스 수를 각각 따로 과장하지 않고, 사업화 연결 가능성과 근거 직접성을 하나의 최종 점수로 통합했습니다.

### 1) 최종 점수 구성
| 구성요소 | 점수 | 가중치 | 가중 반영 | 의미 |
|---|---:|---:|---:|---|
| Tech-to-Value Bridge | 80.53 | 0.45 | 36.24 | 기술이 고객 채택·양산·매출 전환으로 이어질 가능성 |
| IP Evidence Composite | 53.56 | 0.20 | 10.71 | 권리 안정성·청구항·인용·패밀리 기반 특허 품질 |
| Excel 기반 정량 근거 | 85.00 | 0.20 | 17.00 | 템플릿/수식 기준에 맞춰 실제 기업별 근거가 얼마나 채워졌는지 |
| 근거 직접성·충분성 | 82.00 | 0.15 | 12.30 | Chair가 개인투자자에게 설명할 수 있는 근거의 직접성 |

### 2) 핵심 해석
- 네패스의 개인투자자용 Tech 최종 점수는 76.25/100이며, 판정은 사업화 연결성이 확인되는 준비형입니다.
...
| tech.inv.ev.007 | tech_summary | **Tech Agent 핵심 해석**: 네패스의 개인투자자용 Tech 최종 점수는 76.25/100이며, 판정은 사업화 연결성이 확인되는 준비형입니다. | - | 중 |
