...
| 고객 구매 이유 | 고객 효익 | 5 / 5 (고객 채택도) | (1) 라텍스 (2) 과산화수소 (3) PAM(고분자응집제) (4) 차아황산소다; 직접근거 9건, 공식/DART/IR/특허 근거 3건, 정량화 지표 9건 | 강 | data\반도체\한솔케미칼\tech\source\dart_latest_business_report.txt |
| 경쟁 우위/대체가능성 | 등록 특허 | 5 / 5 (진입장벽) | 산업재산권 제도ᆞ출원 심사 등록 수수료 등; 직접근거 12건, 공식/DART/IR/특허 근거 11건, 정량화 지표 12건 | 강 | https://www.kipris.or.kr/khome/main.jsp |
...
| R&D 강도 | 연구개발비 | 5 / 5 (투자 지속성) | KPA 서지정보 제공 안내(특허 공개일: 2026년 4월 1일 ∼ 30일); 직접근거 9건, 공식/DART/IR/특허 근거 9건, 정량화 지표 6건 | 강 | https://www.kipris.or.kr/khome/main.jsp |
...
| 대표 특허 예시 | 상태/연도 |
|---|---|
| 신규 화합물, 이를 포함하는 전구체 조성물, 및 이를 이용한 박막의 제조방법 | 등록 |
| 신규 화합물, 이의 제조방법, 이를 포함하는 전구체 화합물 및 이를 이용한 박막의 제조방법 | 등록 |
...
| 항목 | 값 | 해석 |
|---|---:|---|
| Tech/IP Strength Index | 55.13/100 | 특허 등록률·존속성·최근성·IPC/CPC 다양성·핵심기술 키워드 밀도 점수를 통합한 IP 강도 지표입니다. |
| Reference Universe Percentile | 50.00% | reference universe 안에서의 상대적 기술/IP 위치입니다. |
| Patent Momentum Score | 34.19/100 | 최근 특허 활동과 기술 포트폴리오 지속성을 반영합니다. |
...
### 9-4. 해석
- 한솔케미칼의 Tech/IP Strength Index는 55.13/100, percentile 50.0로 산출되어 중간 수준 IP 포지션으로 해석됩니다. NMF 기준 주된 기술 주제는 '주요 topic 확인 제한'입니다. 단, 이 지표는 기술/IP 포트폴리오 상대 강도 신호이며 고객 채택·양산·매출 전환·FCF 개선 근거를 대체하지 않습니다.
