# Auditor Valuation/Credit/ML Overlay - 한솔케미칼
...
- 신용위험 ML 판단: LOW_RISK
- 해석: 한솔케미칼는 반도체 딥테크 peer universe 내에서 가치평가 ML 판단은 ATTRACTIVE, 신용위험 ML 판단은 LOW_RISK로 분류된다.
- Auditor 판단: 최종 보고서에서는 성장성·저평가 가능성뿐 아니라 수익성, 현금흐름, 재무안정성 리스크도 함께 검토해야 한다.

## Credit Assessment
- signal: caution
- watch_grade: C
- risk_drivers: 영업이익률 -17.67%로 사업 수익성 미흡; 순이익률 -16.76%로 손실 흡수력 점검 필요; ROE -12.58%로 자본효율성 부진; 기간 MDD -76.38%로 시장 신용/자본조달 리스크 확대

## Valuation Assessment
- valuation_signal: valuation_neutral
- dcf_available: True
- ev_proxy_to_sales: 2.4087
- cautions: 영업이익률 -17.67%; 기간 MDD -76.38%로 시장 할인 요인 존재

## ML / Model-Risk Overlay
- trained_proxy_available: True
- trained_valuation_signal: ATTRACTIVE
- trained_valuation_confidence: 0.8365
- trained_credit_label: LOW_RISK
- trained_credit_confidence: 0.9712
- trained_credit_anomaly_score: 0.0582
...
- downside_risk_score: 0.3733
- upside_support_score: 0.518
- peer_anomaly: 동종 샘플이 부족해 peer anomaly는 제한적으로만 해석합니다.

## Sources
- financial_csv=한솔케미칼_재무.csv
- stock_csv=한솔케미칼_주식.csv
- auditor_overlay_artifact=C:\Agent_6.8\data\반도체\한솔케미칼\auditor\first_auditor\valuation_credit_overlay.json
