# SFA반도체 Tech Local Proxy Evidence

- company_name: SFA반도체
- company_slug: sfa_semicon
- stock_code: 036540
- market: KOSDAQ
- peer_group: 후공정/패키징/테스트
...
SFA반도체은 Universe CSV에서 '후공정/패키징/테스트' peer_group으로 분류되어 있습니다.
이 분류에 따라 Tech Agent는 다음 기술 후보 키워드를 우선 탐색합니다: 반도체, 공정, 양산, 고객, R&D, 특허, 기술경쟁력, 후공정, 패키징, 테스트, WLP, Bumping, 수율, 검사, 소켓, 신뢰성.

## 대표 기술 후보

- 반도체 value chain 내 위치: 후공정/패키징/테스트
- 탐색해야 할 기술 축: 반도체, 공정, 양산, 고객, R&D, 특허, 기술경쟁력, 후공정, 패키징, 테스트
- 핵심 확인 필요 항목: 제품/공정 직접성, 고객 적용 여부, 양산/수율/신뢰성 지표, R&D 및 특허 근거, 전방산업 확장성

## 핵심 제품/서비스 후보

- peer_group 기준 후보: 후공정/패키징/테스트
