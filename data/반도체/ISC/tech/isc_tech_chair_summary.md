...
- Source: `data/반도체/ISC/tech/tech_ip_evidence_composite.json`
...
### 2) 핵심 해석
- ISC의 개인투자자용 Tech 최종 점수는 48.12/100이며, 판정은 기술 또는 IP 근거가 초기/제한적이어서 보수적 해석 필요입니다.
- 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(43.0)와 IP Evidence(62.36) 및 Excel 기반 정량 근거(45.0)를 함께 반영했습니다.
...
| tech.inv.ev.007 | tech_summary | **Tech Agent 핵심 해석**: ISC의 개인투자자용 Tech 최종 점수는 48.12/100이며, 판정은 기술 또는 IP 근거가 초기/제한적이어서 보수적 해석 필요입니다. | - | 중 |
| tech.inv.ev.008 | tech_summary | **Tech Agent 핵심 해석**: 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(43.0)와 IP Evidence(62.36) 및 Excel 기반 정량 근거(45.0)를 함께 반영했습니다. | - | 중 |
