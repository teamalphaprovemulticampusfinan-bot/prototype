...
| 원천 신호 | 값 |
|---|---:|
| 정규화 특허 텍스트 레코드 | 4,718건 |
| 회사 출원인/권리자 매칭 | 3,101건 |
| 등록 특허 | 385건 |
| 존속 가능 특허 | 2,245건 |
| 최근 5년 특허 | 1,560건 |
| IPC/CPC 다양성 | 10개 |
...
- Source: `C:/Agent_6.9/data/반도체/미코/tech/tech_ip_evidence_composite.json`
...
| 근거 직접성·충분성 | 65.67 | 0.15 | 9.85 | Chair가 개인투자자에게 설명할 수 있는 근거의 직접성 |
| 사업화·성장자금 지속성 | 63.50 | 0.10 | 6.35 | R&D·특허·정부과제·기술이전·CAPEX/희석성 자금조달이 사업화와 연결되는 정도 |

### 2) 핵심 해석
- 미코의 개인투자자용 Tech 최종 점수는 55.31/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다.
- 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(39.0)와 IP Evidence(50.06) 및 Excel 기반 정량 근거(90.0)를 함께 반영했습니다.
...
| tech.inv.ev.007 | tech_summary | **Tech Agent 핵심 해석**: 미코의 개인투자자용 Tech 최종 점수는 53.91/100이며, 판정은 기술성은 확인되나 양산·고객 채택·재무성과 전환을 계속 추적해야 함입니다. | - | 중 |
| tech.inv.ev.008 | tech_summary | **Tech Agent 핵심 해석**: 최종 판단은 단순 특허 수보다 Tech-to-Value Bridge(39.0)와 IP Evidence(50.06) 및 Excel 기반 정량 근거(90.0)를 함께 반영했습니다. | - | 중 |
