# 피에스케이 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 56.7
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 67.6 | 16.9 | OK | IP_LEGAL_STABILITY_NEUTRAL |
| claim_defense | 청구항 방어 범위 | 0.3 | 50.89 | 15.27 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 45.0 | 11.25 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 66.4 | 13.28 | OK | IP_GLOBAL_EXTENSION_POSITIVE |
