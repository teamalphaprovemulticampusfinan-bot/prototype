# 덕산테코피아 IP Evidence Composite Score

## 1. Summary
- status: OK
- ip_evidence_composite_score: 52.54
...
|---|---:|---:|---:|---:|---|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 82.25 | 20.56 | OK | IP_LEGAL_STABILITY_STRONG_POSITIVE |
| claim_defense | 청구항 방어 범위 | 0.3 | 60.93 | 18.28 | OK | IP_CLAIM_SCOPE_NEUTRAL |
| citation_influence | 인용 기반 기술 영향력 | 0.25 | 30.26 | 7.57 | OK | IP_CITATION_FALLBACK_ESTIMATED |
| global_extension | 해외 패밀리 기반 글로벌 확장성 | 0.2 | 30.68 | 6.14 | OK | IP_GLOBAL_EXTENSION_WEAK |
