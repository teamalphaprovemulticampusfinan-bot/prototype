...
## 1. Chair 반영용 핵심 판단
- **의견:** 매수
- **Tech-to-Value:** base 76.00/100 / 가치 전환 확인형(VALUE_CONVERSION_CONFIRMED)
- **Peer-adjusted:** 80.85/100 / 사업화 추적형(COMMERCIALIZATION_WATCH)
- **IP Evidence Composite:** 33.91/100 / IP 근거 취약형(IP_EVIDENCE_WEAK)
...
| IP Legal Stability | 66.63/100 | 등록률·존속률·소멸/거절/취하 비중 기반 권리 안정성 |
...
| IP Evidence Composite | 33.91/100 | 법적 안정성·청구항·인용·패밀리 특허를 통합한 종합 IP 근거 점수 |
...
|---|---:|---:|---:|---|
| 등록·존속 안정성 | 0.25 | 66.63/100 | 16.66점 | OK |
...
- IP Evidence Composite Score: **33.91 / 100**
...
|---|---|---:|---:|---:|---|
| legal_stability | 등록·존속 안정성 | 0.25 | 66.63 | 16.66 | OK |
...
- Source: `data/반도체/한미반도체/tech/tech_ip_evidence_composite.json`
